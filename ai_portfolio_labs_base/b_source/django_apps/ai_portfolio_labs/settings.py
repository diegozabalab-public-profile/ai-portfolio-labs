"""
Django settings for ai_portfolio_labs_base project.
...
SECRET_KEY = \
    'django-insecure-ztmq+*x!l=*a=73ugcyvb17(s0)+q!_24d24(@nya)qnlxnup6'
...
STATIC_FILES_ROOT_FOLDER_PATH = os.path.join(BASE_DIR, "static_files")
